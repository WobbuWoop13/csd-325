#Rachel Shaw, Tanessa Burns, Kyle Marlia-Conner - 6.2 Assignment - 11/22/2024
...
# CHANGES:
# added lake in the center of the map
...
def createNewForest():
    ...
    # setting lake position and size 
    for x in range(WIDTH - 47, WIDTH - 40):
        for y in range(HEIGHT - 11, HEIGHT - 3):
            forest[(x,y)] = WATER
